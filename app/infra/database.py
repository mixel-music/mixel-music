...
tracks = sqlalchemy.Table(
    "tracks",
    metadata,
    sqlalchemy.Column("acoustid_id", sqlalchemy.String, nullable=False),
    ...
    sqlalchemy.Column("releasecountry", sqlalchemy.String, nullable=False),
    ...
    sqlalchemy.Column("trackid", sqlalchemy.String, nullable=False, primary_key=True),
